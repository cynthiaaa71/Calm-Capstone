...
import img1 from '../images/home-main-img3.png';
  ...
  const fetchJoke = async () => {
    ...
    return (
      <div className='home-page'>
        ...
        <h3 className="marquee" style={{ color: '#fbf3f2' }}>
         Lifeline Number for Embrace Lebanon :  1564 
        </h3>
      </div> */}
        <div className='home-allcontent'>

        <div className='home-project-intro-image'>
          <img src={img1} alt='Calm: Embrace, Empower, Elevate' ></img>
        ...
        <p>
          ...
          Calm has many such resources to make you smile even when you feel you can't. We also offer a variety of other resources to help you 
